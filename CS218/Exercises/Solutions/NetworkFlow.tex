...
\begin{enumerate}[label=\textbf{\arabic*.}]
  ...
  There are 4 residual paths we will keep using, $A$, $B$ and $C$. 
  ...
  \begin{itemize}
    ...
    \item Push along path $A$, adding $\phi^{k+1}$ flow. The capacities become $0, \phi^{k+1}, \phi^k + \phi^{k+1} = \phi^{k+2}$
  \end{itemize}
