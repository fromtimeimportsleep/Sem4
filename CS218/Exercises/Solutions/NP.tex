...
\begin{enumerate}[label=\textbf{\arabic*.}]
    ...
    From $sum(S) \leq W_2$ we get $sum(S) + y \leq W_2 + y = W_2 + \sum_i w_i = T$. Also $W_1 \leq sum(S)$ gives $y - sum(S) \leq y - W_1$
    i.e. $sum(S^c) \leq y - W_1$. Adding $x$ to both sides, $sum(S^c) + x \leq y + x - W_1 = y + W_2 = T$.
