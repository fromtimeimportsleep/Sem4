...
physical address the MMU walks along the page table arrays. This why the MMU accessing the page table is called walking the table. 
...
It is important to note that every element of memory needed by a process has a virtual address associated with it. 
\end{document}
